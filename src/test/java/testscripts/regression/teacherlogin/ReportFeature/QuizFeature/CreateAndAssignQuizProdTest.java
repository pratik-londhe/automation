...
public class CreateAndAssignQuizProdTest extends BaseTestScript {
    ...
    public void verifyFunctionalityOfCreate() {
        ...
        try {
            ...
            /*quizPage.clickOnSaveButtonProd();
            quizPage.enterAssignmentName();
            quizPage.selectDueDate();
            quizPage.saveAssignment();*/
        } catch (Exception e) {
            result = handleException(e);
        }
        Assert.assertTrue(result, testCaseFailureText + currentMethodName + errorMessage);
