...
public class ZeroDimensionTest extends BaseTestScript {
    ...
    public void verifyPointInteractiveTest() {
        ...
        try {
            ...
            Assert.assertTrue(threeDimensionsPage.beforeMouseHover(), "Failed to verify POINT interactive is not highlighted before mouse hover.");
            extentTest.log(LogStatus.PASS, "User successfully verify that POINT interactive is not highlighted before mouse hover.");
            logger.info("User successfully verify that POINT interactive is not highlighted before mouse hover.");

            threeDimensionsPage.mouseHoverOnPointInteractive();
            ...
            Assert.assertTrue(threeDimensionsPage.afterMouseHover(), "Failed to verify POINT interactive is highlighted");
            extentTest.log(LogStatus.PASS, "User successfully verify that POINT interactive is highlighted after mouse hover.");
            logger.info("User successfully verify that POINT interactive is highlighted after mouse hover.");

            threeDimensionsPage.mouseOutOnPointInteractive();
            extentTest.log(LogStatus.PASS, "User successfully done mouse out on POINT interactive.");
            logger.info("User successfully done mouse out on POINT interactive.");
           ...
           /* Assert.assertTrue(threeDimensionsPage.verifyNetworkEvent(), "Failed to verify POINT interactive Events.");
            extentTest.log(LogStatus.PASS, "User successfully verify that POINT interactive is highlighted after mouse hover.");
            logger.info("User successfully verify that POINT interactive is highlighted after mouse hover.");*/
        } catch (Exception e) {
