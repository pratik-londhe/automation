...
public class PostgreSqlConnector extends Doer {
	...
	protected void connectToDb(String hostname, String dbname, String port, String username, String password) {
		...
		try {
			db = new PostgreSqlDB(hostname, port, dbname, username, password);
		} catch (Exception e) {
			skipScenario(e, "Unable to connect to PostgreSqlDB");
		}
	}
